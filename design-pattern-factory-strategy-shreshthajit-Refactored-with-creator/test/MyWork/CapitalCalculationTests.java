...
import factory.FactoryMethodMain;
...
public class CapitalCalculationTests {
    ...
    public void test_term_loan_no_payments() {
        Loan loan = FactoryMethodMain.CreateTermLoan(Commitment, RiskRating, _maturity);
    ...
    public void test_revolver_loan_no_payments() {
        Loan loan = FactoryMethodMain.CreateRevolver(Commitment, RiskRating, null, _expiry);
    ...
    public void test_RCTL_loan_one_payment() {
        Loan loan = FactoryMethodMain.CreateRCTL(Commitment, Outstanding, RiskRating, _maturity, _expiry);
